...
//                                .datePickerStyle(.graphical)
 ...
 //                                 }
                ...
                ZStack{
                   ...
                   .onAppear() {
                            cartManager.addToCart(allServies: serviesList[2])
                           }
...
struct newrequst1_Previews: PreviewProvider {
    static var previews: some View {
        newrequst1(myorder: OrderForFeed(order: Order(dictionary: [:]), user: User(dictionary: [:]), orderID: ""), allServies: serviesList[0])
            .environmentObject(CartManager())
