...
//  Macro
//
//  Created by najat ali on 18/12/1443 AH.
//

import SwiftUI
import FirebaseAuth

struct newrequest2: View {
...
//                                 }
               ...
               ZStack{
                  ...
                  .onAppear() {
                           cartManager.addToCart(allServies: serviesList[3])
                          }
...
struct newrequest2_Previews: PreviewProvider {
    static var previews: some View {
        newrequest2(myorder: OrderForFeed(order: Order(dictionary: [:]), user: User(dictionary: [:]), orderID: ""), allServies: serviesList[0])
            .environmentObject(CartManager())
