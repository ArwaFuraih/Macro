...
//                                 }
               ...
               ZStack{
                  ...
                  .onAppear() {
                           cartManager.addToCart(allServies: serviesList[4])
                          }
...
struct newreqeust3_Previews: PreviewProvider {
    static var previews: some View {
        newreqeust3(myorder: OrderForFeed(order: Order(dictionary: [:]), user: User(dictionary: [:]), orderID: ""), allServies: serviesList[0])
            .environmentObject(CartManager())
